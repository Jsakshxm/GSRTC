  ...
  return (
    <div className='flex justify-center pt-16'>
      <div className="form">
        ...
        <input className="input" name="name" placeholder="Name" type="text" value={Name} onChange={(e) => setName(e.target.value)} />
        <input className="input" name="email" placeholder="Email" type="email" value={Email} onChange={(e) => setEmail(e.target.value)} />
        ...
        <Link href="/PassengerLogin">
          <p className='p-2 m-2 text-lg font-semibold'>Already have an Account?</p>
        </Link> 
